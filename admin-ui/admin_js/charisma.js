$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', 'http://localhost/sport/admin-ui/admin_bower/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', 'http://localhost/sport/admin-ui/admin_css/bootstrap-' + themeName + '.min.css');
        }
