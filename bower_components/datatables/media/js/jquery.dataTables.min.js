...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"الأول",sLast:"الأخير",sNext:"التالى",sPrevious:"السابق"},sEmptyTable:"No data available in table",sInfo:"إظهار _START_ إلى _END_ من أصل _TOTAL_ مُدخل",sInfoEmpty:"يعرض 0 إلى 0 من أصل 0 سجلّ",
sInfoFiltered:"(منتقاة من مجموع _MAX_ مُدخل)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"أظهر مُدخلات _MENU_",sLoadingRecords:"Loading...",sProcessing:"جاري التحميل...",sSearch:"أبحث:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"لم يُعثر على أية سجلات"},oSearch:g.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
