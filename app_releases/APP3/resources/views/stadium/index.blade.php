		...
		<div class="container-fluid">
              ...
              <br>
                  ...
                  <ul class="alerts-list" style="display:none;" id="show">
                      <li>
                          <div class="alert alert-success alert-dismissable">
                              <i class="icon-remove-sign"></i> تم أضافة أستاد بنجـــــــــاح!.
                  ...
                  <a class="btn btn-primary" data-toggle="modal" data-target="#addModal" style="margin-bottom:20px;" >
		                  <i class="fa fa-plus-circle"  style="font-size: 18px;"></i> أضافة أستاد
                  </a>
				                      ...
				                      <table id="players" class="table table-striped table-bordered table-hover datatable">
						                        <thead>
								                            <tr>
										                            ...
										                            <th class="col-md-1">السعه</th>
                   	                            <th class="col-md-1">الصوره</th>
										                            <th class="col-md-1">الأرضيه</th>
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              <div class="modal-header">
                                  ...
                                  <h4 class="modal-title" id="addModalLabel"><i class="fa fa-plus-circle"></i> أضافة استاد</h4>
                              </div>
                              <form role="form" method="POST" class="addForm" action="{{ url('/stadium/store') }}" data-toggle="validator" enctype="multipart/form-data">
                                   <div class="modal-body">
                                        @include('stadium.form')
                                   </div>
                   ...
                   <div class="modal fade" id="editcityModal" tabindex="-1" role="dialog" aria-labelledby="editEmployeeModalLabel" aria-hidden="true">
                       <div class="modal-dialog">
                           <div class="modal-content">
                               ...
                               <form role="form" id="update_form" method="POST" class="editForm" data-id="" action="{{ url('stadium/update') }}" data-toggle="validator" enctype="multipart/form-data">
                                   <div class="modal-body">
                                       @include('stadium.formupdate')
                                   </div>
                                   <div class="modal-footer">
  ...
  oTable.draw();
	...
	oTable.draw();
	    ...
	    var self = $(this);
	         self.button('loading');
	         $.ajax({
	             url: "{{ url('stadium') }}" + "/" + self.data('id') + "/edit" ,
	             type: "GET",
	             success: function(res){
	                 self.button('reset');
                ...
                "processing": true,
	                   ...
	                   {data: 'stadium_image', name: 'stadium_image'},
