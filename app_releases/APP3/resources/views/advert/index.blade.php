            ...
            <br>
                ...
                <ul class="alerts-list" style="display:none;" id="show">
                    <li>
                        <div class="alert alert-success alert-dismissable">
                            <i class="icon-remove-sign"></i> تم أضافة أعلان بنجـــــــــاح!.
                ...
                <ul class="alerts-list" style="display:none;" id="showupdate">
                  ...
                  <a class="btn btn-primary" data-toggle="modal" data-target="#addModal" style="margin-bottom:20px;" >
		                  <i class="fa fa-plus-circle" style="font-size: 18px;"></i> أضافة أعلان
                  </a>
                  <div class="widget-content-white glossed">
		                  <div class="padded">
				                    <table id="countries" class="table table-striped table-bordered table-hover datatable">
                                                ...
                                                <th class="col-md-1">الصفحه</th>
                                                <th class="col-md-1">المكان</th>
                          ...
                          <div class="modal-dialog">
                              <div class="modal-content">
                                  <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="addModalLabel"><i class="fa fa-plus-circle"></i> Add advert</h4>
                                  </div>
                                  <form role="form"  method="POST" class="addForm" action="{{ url('/advert/store') }}" data-toggle="validator"  enctype="multipart/form-data" >
                      ...
                      <div class="modal fade" id="editcountryModal" tabindex="-1" role="dialog" aria-labelledby="editEmployeeModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                              <div class="modal-content">
                                  ...
                                  <form role="form"  method="POST" class="editForm" data-id="" action="{{ url('/advert/update') }}" data-toggle="validator" enctype="multipart/form-data">
                                      <div class="modal-body">
                                        @include('advert.formupdate')
                                      </div>
                                      <div class="modal-footer">
...
function advert_place2(){
  $page_name=$('#page_name2').val();
  if($page_name == "Home"){
    $('#home_page2').show();
    $('#remain_page2').hide();
  }
		...
		function populateForm(response, frm)
    {
       ...
       //Edit Form
           ...
           $('.editForm')[0].reset();
		         ...
		         self.button('loading');
		         $.ajax({
		             url: "{{ url('advert') }}" + "/" + self.data('id') + "/edit" ,
		             type: "GET",
		             success: function(res){
		                 self.button('reset');
