...
<div class="form-group">
    ...
    <input type="url" class="form-control" name="vedio_url" id="vedio_url" placeholder="vedio_url" required class="form-control">
    <span class="help-block with-errors errorName"></span>
</div>

<div class="form-group">
    <label class="control-label" style="display: block;">التاريخ(Year/Month/Day)</label>
    <input id="datetime2" data-format="YYYY-MM-DD" data-template="YYYY / MM / DD" name="date" value="" type="text">
</div>
