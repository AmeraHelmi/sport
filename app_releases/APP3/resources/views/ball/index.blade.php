        ...
        <div class="row">
              ...
              <br>
                ...
                <div class="widget-content-white glossed">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="addModalLabel"><i class="fa fa-plus-circle"></i> Add ball</h4>
                                    </div>
                                    <form role="form" method="POST" class="addForm" action="{{ url('/ball/store') }}" data-toggle="validator" enctype="multipart/form-data">
                        ...
                        <div class="modal fade" id="editballModal" tabindex="-1" role="dialog" aria-labelledby="editEmployeeModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
$(document).ready(function() {
  ...
  oTable.draw();
	    ...
	    var self = $(this);
	         self.button('loading');
	         $.ajax({
	             url: "{{ url('ball') }}" + "/" + self.data('id') + "/edit" ,
	             type: "GET",
	             success: function(res){
	                 self.button('reset');
	                 $data = JSON.parse(res.data);
									 populateForm($data, document.getElementsByClassName("editForm")[0] );
	                 $('#editballModal form').attr("data-id", self.data('id') );
	                 $('#editballModal').modal('show');
	             },
	             error: function(){
	                 self.button('reset');
	                 $('.alerts-list').append(
