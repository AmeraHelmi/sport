						...
						<br>
								<ul class="alerts-list delete"></ul>
										<a class="btn btn-primary" data-toggle="modal" data-target="#addModal" style="margin-bottom:20px;" >
												<i class="fa fa-plus-circle"  style="font-size: 18px;"></i> أضافة راعى للفريق
										</a>
										<div class="widget-content-white glossed">
												<div class="padded">
														<table id="cities" class="table table-striped table-bordered table-hover datatable">
																<thead>
																		<tr>
																				<th class="col-md-4">أسم الفريق</th>
										...
										<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
    										<div class="modal-dialog">
        										<div class="modal-content">
            										...
            										<form role="form" method="POST" class="addForm" action="{{ url('/team_sponsor/store') }}" data-toggle="validator">
                											<div class="modal-body">
                    											@include('team_sponsors.form')
                											</div>
										...
										<div class="modal fade" id="editchampionModal" tabindex="-1" role="dialog" aria-labelledby="editEmployeeModalLabel" aria-hidden="true">
    										<div class="modal-dialog">
        										<div class="modal-content">
            										...
            										<form role="form" id="update_form" method="POST" class="editForm" data-id="" action="{{ url('/team_sponsor/update') }}" data-toggle="validator">
                											<div class="modal-body">
                    											@include('team_sponsors.form')
                											</div>
                											<div class="modal-footer">
