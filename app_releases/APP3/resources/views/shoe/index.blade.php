		...
		<div class="container-fluid">
              ...
              <br>
                  ...
                  <ul class="alerts-list" style="display:none;" id="show">
                      <li>
                          <div class="alert alert-success alert-dismissable">
                              <i class="icon-remove-sign"></i>تم أضافة حذاء بنجـــــــــاح!.
                  ...
                  <div class="widget-content-white glossed">
		                  <div class="padded">
				                    <table id="shoes" class="table table-striped table-bordered table-hover datatable">
						                      <thead>
								                        <tr>
                      ...
                      <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                              <div class="modal-content">
                                  ...
                                  <form role="form" method="POST" class="addForm" action="{{ url('/shoe/store') }}" data-toggle="validator" enctype="multipart/form-data">
                      ...
                      <div class="modal fade" id="editshoesModal" tabindex="-1" role="dialog" aria-labelledby="editEmployeeModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                              <div class="modal-content">
                                  <div class="modal-header">
                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                  ...
                                  <form role="form" id="update_form" method="POST" class="editForm" data-id="" action="{{ url('shoe/update') }}" data-toggle="validator" enctype="multipart/form-data">
                                      <div class="modal-body">
                                          @include('shoe.form')
                                      </div>
                                      <div class="modal-footer">
...
<script type="text/javascript">
	...
	oTable.draw();
	    ...
	    var self = $(this);
	         self.button('loading');
	         $.ajax({
	             url: "{{ url('shoe') }}" + "/" + self.data('id') + "/edit" ,
	             type: "GET",
	             success: function(res){
	                 self.button('reset');
	                 $data = JSON.parse(res.data);
									 populateForm($data, document.getElementsByClassName("editForm")[0] );
	                 $('#editshoesModal form').attr("data-id", self.data('id') );
	                 $('#editshoesModal').modal('show');
	             },
	             error: function(){
	                 self.button('reset');
	                 $('.alerts-list').append(
