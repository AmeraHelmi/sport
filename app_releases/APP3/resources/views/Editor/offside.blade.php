...
<select id="teamid"  class="form-control" onchange="offside()" name="team_id">
...
<div class="form-group" style="display:none;" id="showplayer2">
<label for="exampleInputFile">Select player</label>
<select id="player_id2"  class="form-control"  name="player_id">
</select>
</div>
