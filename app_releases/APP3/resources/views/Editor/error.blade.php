...
<select id="team_id5"  class="form-control" onchange="error()" name="team_id">
...
<div class="form-group" style="display:none;" id="showplayer5">
<label for="exampleInputFile">Select player</label>
<select id="player_id5"  class="form-control"  name="player_id">
</select>
</div>
